...
int kiss_renderimage_precise(SDL_Renderer *renderer, kiss_image image,
...
SDL_Renderer* kiss_init(SDL_Window *window, kiss_array *a, int w, int h)
{
	...
	r += kiss_font_new(&kiss_textfont, "assets/fonts/standard.ttf", a,
		kiss_textfont_size);
	r += kiss_font_new(&kiss_buttonfont, "assets/fonts/standard.ttf", a,
		kiss_buttonfont_size);
	r += kiss_image_new(&kiss_normal, "assets/ui/normal.png", a, renderer);
	r += kiss_image_new(&kiss_prelight, "assets/ui/prelight.png", a, renderer);
	r += kiss_image_new(&kiss_active, "assets/ui/active.png", a, renderer);
	r += kiss_image_new(&kiss_bar, "assets/ui/bar.png", a, renderer);
	r += kiss_image_new(&kiss_vslider, "assets/ui/vslider.png", a, renderer);
	r += kiss_image_new(&kiss_hslider, "assets/ui/hslider.png", a, renderer);
	r += kiss_image_new(&kiss_up, "assets/ui/up.png", a, renderer);
	r += kiss_image_new(&kiss_down, "assets/ui/down.png", a, renderer);
	r += kiss_image_new(&kiss_left, "assets/ui/left.png", a, renderer);
	r += kiss_image_new(&kiss_right, "assets/ui/right.png", a, renderer);
	r += kiss_image_new(&kiss_combo, "assets/ui/combo.png", a, renderer);
	r += kiss_image_new(&kiss_selected, "assets/ui/selected.png", a, renderer);
	r += kiss_image_new(&kiss_unselected, "assets/ui/unselected.png", a,
		renderer);
	if (r) {
		kiss_clean(a);
		return NULL;
